...
INSERT INTO products (id, name, description, price, type, tag, active) VALUES
  ...
  ('course', 'Курс лікаря: сон без таблеток', 'Повний відеокурс від лікаря-сомнолога. 8 модулів, 40+ відеоуроків, практичні техніки, особистий зворотній зв''язок.', 249, 'video', 'Курс', true)
