    ...
    <section id="how-it-works" className="py-20 px-4 bg-slate-950">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 text-lg">Від тесту до нормального сну — за кілька кроків</p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.number} className="bg-white/5 rounded-xl p-6 border border-white/10 relative">
              <div className="text-4xl font-bold text-indigo-400/30 mb-4 font-mono">{step.number}</div>
