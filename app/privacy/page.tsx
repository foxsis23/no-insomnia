    ...
    <>
      ...
      <main className="flex-1 bg-slate-950 min-h-screen">
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 p-8 prose prose-slate max-w-none text-sm leading-relaxed">
            <h2 className="text-base font-semibold text-white mt-0">1. Загальні положення</h2>
            ...
            <h2 className="text-base font-semibold text-white mt-6">2. Які дані ми збираємо</h2>
            ...
            <h2 className="text-base font-semibold text-white mt-6">3. Як ми використовуємо дані</h2>
            <ul className="text-slate-300 space-y-1">
            ...
            <h2 className="text-base font-semibold text-white mt-6">4. Захист даних</h2>
            <p className="text-slate-300">
            ...
            <h2 className="text-base font-semibold text-white mt-6">5. Ваші права</h2>
            <p className="text-slate-300">
